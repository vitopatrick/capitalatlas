      ...
      <div className="mt-4">
        ...
        <div>
          <p className="text-muted">
            capital atlas is the most trustworthy platform. We are now a fully
        ...
        <div className="mt-3">
          <p className="text-muted">Central Registration Depository: 166144</p>
          <p className="text-muted">
            U.S. Securities and Exchange Commission: 806-106722
          </p>
          <p className="text-muted">Registration Type: Initial Registration</p>
          <p className="text-muted">Legal Name: Finrock Wealth Management</p>
          <p className="text-muted">Alternative Name: Crptia Advisory</p>
